...
<head>
    ...
    <title>Contact | Jose Anillo</title>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12" data-wow-delay=".2s">
                <h1 class="section-title">Contact José Anillo</h1>
            </div>
        </div>
        <div class="row">
            <!-- Section Titile -->
            ...
            <div class="col-md-6 wow animated fadeInRight" data-wow-delay=".2s">
                <form class="shake" role="form" method="post" id="contactForm" name="contact-form" data-toggle="validator" action="{{ route('email.index') }}">
                    ...
                    <div class="form-submit mt-5">
                        <button class="btn" style="background-color: white; color: black;" type="submit" id="form-submit"><i class="material-icons mdi mdi-message-outline"></i>Send email</button>
